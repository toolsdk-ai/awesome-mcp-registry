...
export const MCPServerPackageConfigSchema = z.object({
	...
	packageVersion: z
		...
		.optional()
		.describe(
			"Version of the package, if not provided then it will use latest version",
		),
	...
	name: z
		...
		.optional()
		.describe(
			"Custom name for display, if empty then it will use the package name",
		),
	description: z.string().optional(),
	readme: z
		.string()
		.optional()
		.describe(
			"URL to the README file, if not provided then it will use the package URL",
		),
	...
	license: z
		.string()
		.optional()
		.describe("Open source license lie MIT, AGPL, GPL, etc"),
	logo: z
		.string()
		.optional()
		.describe(
	...
	author: z
		.string()
		.optional()
		.describe("Author name of the ToolSDK.ai's developer ID"),
	env: z
		.record(
			z.object({
